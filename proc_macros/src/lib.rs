...
//             let result = GDECODER.processor.decode(0b1010_1110).unwrap();
...
// 
//             let result = GDECODER.processor.decode(0b1010_1111).unwrap();
...
// 
//             let result = GDECODER.processor.decode(0).err();
